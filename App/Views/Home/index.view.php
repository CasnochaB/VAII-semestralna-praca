...
<div class="container carousel-recipe" >
	<h1>
		Nové
	</h1>
	<div id="demo" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner ">
			...
			<div class="carousel-item">
				<img class="d-block w-100 fixed-aspect" src="public/assets/recepty/hamburger.png" alt="Second slide">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100 fixed-aspect" src="public/assets/recepty/veternik.png" alt="Third slide">
			</div>
		</div>
